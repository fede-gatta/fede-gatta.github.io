...
<div class="paper-item">
  <h3>Deviations from Tradition: Stylized Facts in the Era of DeFi (2025)</h3>
...
<div class="paper-item">
  <h3>A Multi-step Approach for Minimizing Risk in Decentralized Exchanges (2024)</h3>
  <p class="authors">Daniele Maria Di Nosse, Federico Gatta</p>
  <p class="journal"><em>arXiv (Cornell University)</em></p>
...
<div class="paper-item">
  <h3>Optimizing Liquidity Provision in Uniswap v3 via Physics-Informed Neural Networks (2026)</h3>
  <p class="authors">Salvatore Cuomo, Federico Gatta, Vincenzo Vocca</p>
  <p class="journal"><em>Journal of Computational and Applied Mathematics</em></p>
